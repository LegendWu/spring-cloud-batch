...
JOB_PARAM VARCHAR(255) NOT NULL,
...
##JOB测试数据
INSERT INTO JOB_ENTITY VALUES ('1',  '早间批', 'daily_batch', '0/15 * * * * ?', '1', '早上6:00-8:00执行', '', null, 'OPEN');
INSERT INTO JOB_ENTITY VALUES ('2',  '晚间批', 'night_batch', '0 0 22 * * ?', '2', '晚上22:00-1:00执行', null, null, 'CLOSE');
INSERT INTO JOB_ENTITY VALUES ('3',  '日间批', 'cycle_batch', '0 0/30 9-20 * * ?', '3', '白天9:00-20:00执行，每半小时执行一次', null, null, 'CLOSE');
INSERT INTO JOB_ENTITY VALUES ('4',  '报表批', 'report_batch', '0 0 3 * * ?', '4', '生成报表批次', null, null, 'CLOSE');
